...
function UserReviews({
  ...
  async function handleUpdateReview(e) {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_RAILS_URL}/reviews/${id}`,
      {
        method: "PATCH",
        headers: {
        ...
        body: JSON.stringify({
          ...
          personal_rating: parseInt(formData.personal_rating),
        }),
      }
    );
    ...
    <div className="user-reviews">
      ...
      <div className="movie-review-details">
        ...
        {canEditReview || canEditAccount ? (
          ...
          <button className="edit-review-button" onClick={toggleEditReview}>
            EDIT REVIEW
          </button>
        )}
        {canEditReview ? (
          <div className="review-modal-content">
            <div className="review-modal-header">
              <span className="review-close" onClick={toggleEditReview}>
                &times;
              </span>
            ...
            <div className="review-modal-body">
              <form onSubmit={handleUpdateReview}>
                ...
                <input
                  type="submit"
                  value="Submit"
                  className="submit-edit-review-btn"
                />
              </form>
              <hr className="profile-hr"></hr>
              <button
                className="delete-review-button"
                onClick={toggleDeleteReview}
              >
                DELETE REVIEW
              </button>
              {canDeleteReview ? (
